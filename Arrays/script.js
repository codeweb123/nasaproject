...
const holidays = ['Christmas', 'Thanksgiving', 'Fourth of July']
holidays.forEach(function(hol) {
    if(hol === 'Christmas' || hol === 'Thanksgiving') {
...
//New Map- Array that houses key/value pairs -objects
//key/value pairs ['uhu', 'JIKO'],
